...
public class KeyAndDoorInitializer : MonoBehaviour
{
    ...
    public List<Vector3Int> keyLocations; // array of vector3s for the locations to spawn in keys
    GameObject[] keys; // for use  when deleting old keys


    public GameObject door; // the game object of a door
    public List<Vector3Int> doorLocations; // array of vector3s for the locations to spawn in doors
    ...
    public void InitializeKeys()
    {
        ...
        keys = new GameObject[keyLocations.Count];
        int i = 0;
    ...
    public void InitializeDoors()
    {
        ...
        if (doors.Length > 0)
        {
            ...
            Quaternion roation = new Quaternion(0, 0, 0, 1);
            doors = new GameObject[doorLocations.Count];
            int i = 0;
