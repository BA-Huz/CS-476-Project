...
public class HealthManager : MonoBehaviour
{
    ...
    public int killBelowY = -999999;
    public AudioSource chickenHurt;
    ...
    void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        // lower player health
        else if ((collision.gameObject.tag == "Enemy" || collision.gameObject.layer == 8 || collision.gameObject.layer == 99) && ! isInvinsible)
        {
