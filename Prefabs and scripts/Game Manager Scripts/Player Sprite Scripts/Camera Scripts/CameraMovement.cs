...
public class CameraMovement : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //parentCC = transform.parent.GetComponent<CharacterController>();
    ...
    void CameraPositioning()
    {
        ...
        {    /*   do nothing   */    }  
        // move right
        else if ((Input.GetKey("d") || Input.GetKey("right")) && (! transform.parent.GetComponent<CharacterMovement>().isNormalForceInDirection(4) && transform.parent.position.x > transform.position.x - 3f))
            xTranslate += 0.1f;
        // move left
